...
void MC_PID_correction(void){
	...
	drone_data->motor_cmd.m11 = drone_data->pid_correction.roll_pid; //-drone_data->pid_correction.roll_pid; //drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m12 = 0;//-drone_data->pid_correction.roll_pid; //-drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m13 = 0;//drone_data->pid_correction.roll_pid;//drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m14 = 0;//drone_data->pid_correction.roll_pid;//-drone_data->pid_correction.pitch_pid;

	drone_data->motor_cmd.m21 = 0;//drone_data->pid_correction.roll_pid;//drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m22 = 0;//drone_data->pid_correction.roll_pid;//-drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m23 = 0;//-drone_data->pid_correction.roll_pid;//drone_data->pid_correction.pitch_pid;
	drone_data->motor_cmd.m24 = 0;//-drone_data->pid_correction.roll_pid;//-drone_data->pid_correction.pitch_pid;
